...
function Rocketdetail() {
  ...
  return (
    <>
      <article className="launcherConfigContainer">
        <div className="configHeader">
          <div className="configTitle divStyle">
            <h1>{res.name}</h1>
            {res.variant && <em>{res.variant} </em>}
            {res.full_name && (
              <span className="fullName">{res.full_name} </span>
            )}
            {res.manufacturer && (
          ...
          <div className="configImage divSmall">
            {res.image?.image_url && (
              <img
          ...
          <div className="configOverview divStyle">
            <h3>Overview</h3>
        ...
        <div className="techSpecs configChild divStyle2">
          <h2>Technical Specifications</h2>
          {res.length !== null && (
            <div className="specItem divSmall">
          ...
          {res.launch_cost !== null && (
            <div className="specItem divSmall">
              <strong>Launch Cost:</strong> ${res.launch_cost.toLocaleString()}{" "}
              USD
            </div>
          )}
        </div>

        <div className="payloadCapacities configChild">
          <h2>Payload Capacities</h2>
          {res.leo_capacity !== null && (
            <div className="capacityItem divSmall">
              <strong>
                <span className="tooltip">
                  LEO
                  <span className="tip">
                    Low Earth Orbit - altitude of approximately 160 to 2,000 km
            ...
            <div className="capacityItem divSmall">
              <strong>
                <span className="tooltip">
                  Apogee
                  <span className="tip">
                    The highest point reached in a sub-orbital flight trajectory
                  </span>
                </span>
                :
              </strong>{" "}
        ...
        <div className="launchStatistics configChild">
        ...
        {(res.successful_landings !== null ||
          ...
          <div className="landingStatistics configChild">
            ...
            {res.successful_landings !== null && (
              <div className="statItem divSmall">
                <strong>Successful Landings:</strong> {res.successful_landings}
              </div>
            )}
        ...
        <div className="configRelated configChild">
          {res.families && res.families.length > 0 && (
            <>
              <h2>Rocket Families</h2>
              <div className="relatedSection">
                {res.families.map((family) => (
                  <div key={family.id} className="familyItem configChild">
                    <strong className="familyName ">{family.name}</strong>
                    ...
                    {family.manufacturer && family.manufacturer.length > 0 && (
                      <div className="familyManufacturers divSmall">
                        <strong>Manufacturers:</strong>
                        {family.manufacturer.map((manu) => (
                          <div
                            key={manu.id}
                            className="familyManufacturersChilds divmall"
                          >
                            <span>
                              {manu.name}
          ...
          {res.manufacturer && (
            <div className="configChild">
              <h2>Manufacturer</h2>
              <div className="manufacturerCard divStyle">
            ...
            <>
              ...
              <div className="">
                {res.program.map((prog) => (
                  <div key={prog.id} className="programCard divStyle">
                    ...
                    <div className="programInfo">
                      <strong className="programName">{prog.name}</strong>
