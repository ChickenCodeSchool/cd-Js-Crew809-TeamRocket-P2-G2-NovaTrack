    ...
    <>
      <article className="launcherConfigContainer">
        <div className="configHeader">
          <div className="configTitle divSmall">
            <h1>{res.name}</h1>
        ...
        <div className="configAllDetails">
          <div className="techSpecs configChild">
                ...
                <div className="manufacturerCard divStyle">
                  ...
                  <div className="manufacturerInfo">
                    ...
                    {res.manufacturer.administrator && (
                      <span>
                        Administrator: {res.manufacturer.administrator}
                      </span>
                    )}
                  </div>
